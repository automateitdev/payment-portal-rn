...
const STEPS: { icon: keyof typeof Ionicons.glyphMap; text: string }[] = [
  ...
  { icon: "document-text-outline", text: "Fill in the applicant details" },
  { icon: "shield-checkmark-outline", text: "Submit — no account needed" },
];

const OnlineAdmissionEntry = () => {
            ...
            <View className="w-full" style={{ maxWidth: 440 }}>
              ...
              <View className="items-center mb-7">
                ...
                <Text className="mt-1.5 text-[13px] text-slate-500 dark:text-slate-400 text-center leading-5">
                  Enter an Institute ID to start an admission application
...
export default OnlineAdmissionEntry;
