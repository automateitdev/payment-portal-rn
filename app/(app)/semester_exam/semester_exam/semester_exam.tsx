        ...
        <View className="px-4 pt-5">
          <View className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-[28px] p-5 overflow-hidden">
            ...
            >
              ...
              <View
                className="bg-slate-50 dark:bg-slate-800/60 rounded-2xl px-4 py-3.5 border border-slate-200 dark:border-slate-700"
                style={{ minWidth: 230 }}
              >
                <View className="flex-row items-center" style={{ gap: 10 }}>
                  ...
                  <View style={{ flex: 1 }}>
                    <Text className="text-[10px] font-bold uppercase tracking-[1.5px] text-emerald-600 dark:text-emerald-400">
                      Student
                    </Text>
                    <Text
                ...
                <View
                  className="mt-3 border-t border-slate-200 dark:border-slate-700 pt-2.5"
                  style={{ gap: 6 }}
                >
                  ...
                  >
                    ...
                    <Text
                      className="text-xs font-semibold text-slate-700 dark:text-slate-200 text-right"
                      numberOfLines={1}
                      style={{ flexShrink: 1 }}
                      selectable={true}
                    >
